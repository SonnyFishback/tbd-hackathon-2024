            ...
            <Card.Root class="w-full">
                <Card.Header>
                    <div class="flex justify-between">
                        <div class="flex gap-4 align-middle align-text-middle place-middle">
                            <div>
                                <GalleryVerticalEnd />
                            </div>
                            <div>
                ...
                <Card.Content>
                    <div class="grid w-full items-center gap-4">
                        <div class="flex flex-col space-y-2">
                            <h1 class="text-xl font-semibold tracking-tight">This is a question generated by ...</h1>
                        </div>
                        <Separator class="mb-8"/>
                        <div class="flex flex-col space-y-2">
